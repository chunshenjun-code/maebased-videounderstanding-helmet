...
save_model_path = 'videomae_best_data_str.pth'
...
class VideoMAEDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #pixel_values = inputs.pixel_values.squeeze(0)
        inputs = self.processor(images=sampled_frames, return_tensors="np")   # 返回 numpy
        pixel_values = torch.from_numpy(inputs.pixel_values).squeeze(0)       # 手动转 tensor
